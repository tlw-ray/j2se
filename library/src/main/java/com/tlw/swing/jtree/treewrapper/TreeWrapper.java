 ...
 */
public class TreeWrapper implements DropState
{
  /**
  ...
  private void initHandler()
  {
    ...
    tree.setCellRenderer( new DnDCellRendererProxy(tree.getCellRenderer(),tree));
    dragSource = new DragSource();
    //DragGestureRecognizer dragGestureRecognizer =dragSource.createDefaultDragGestureRecognizer( tree,DnDConstants.ACTION_COPY_OR_MOVE, new TreeDragGestureListener() );
          ...
          implements PropertyChangeListener
  {
    public void propertyChange(PropertyChangeEvent evt)
    {
      ...
      if ( name.equals( JTree.CELL_RENDERER_PROPERTY ) )
      {
        ...
        {
          rendererProxy = new DnDCellRendererProxy( renderer,tree );
...
//      tree.repaint();
          ...
          implements DropTargetListener
  {
    ...
    public void dragOver(DropTargetDragEvent dtde)
    {
      ...
      rendererProxy.setDropBehindAllowed( mayDropHere );
  ...
  //返回DropState接口中的常量;
  int getDropState(JTree aSourceTree, MutableTreeNode aSourceNode, TreeNode aNode){
    boolean mayDropHere =
            ( aNode != aSourceNode )
                    &&
                    ( aNode instanceof MutableTreeNode )
  ...
  private void resetDragAndDrop()
  {
    ...
    rendererProxy.setDropBehindAllowed( false );
    rendererProxy.setDropNode( null );
    tree.repaint();
  }
