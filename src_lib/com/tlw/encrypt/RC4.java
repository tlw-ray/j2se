...
public final class RC4 { // must be final for security reasons
	public static void main(String[] args) throws CryptoException, IOException{
		...
		b2[2]=(byte)0x31;
		b2[3]=(byte)0x32;
		UtilRc4.showBytes(b2);
		
		String key,content;
		key="0";
		content="000000111111222222333333";
		showInfos(key,content);
		
		content="111111222222333333";
		showInfos(key,content);
		
		content="222222333333";
		showInfos(key,content);
		...
		byts[2]=(byte) 0xFB;
		byts[3]=(byte) 0xFF;
		UtilRc4.showBytes(byts);
	}
	static RC4 rc40=new RC4();
	static RC4 rc41=new RC4();
	public static void showInfos(String key,String content) throws CryptoException{
		byte[] keyBytes=key.getBytes();
		UtilRc4.showBytes(keyBytes);
		
		byte[] contentBytes=content.getBytes();
		UtilRc4.showBytes(contentBytes);
		
		rc40.engineInitEncrypt(keyBytes);
		byte[] encryptBytes=rc40.crypt(contentBytes);
		UtilRc4.showBytes(encryptBytes);

		rc41.engineInitDecrypt(keyBytes);
		byte[] decryptBytes=rc41.crypt(encryptBytes);
		UtilRc4.showBytes(decryptBytes);
	}
...
//............................................................................
    ...
    class CryptoException extends Exception {
		private static final long serialVersionUID = 407986442689151620L;
